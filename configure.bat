...
echo(
echo Configuration OpenCode (Azure Foundry)
echo -----------------------------------------
echo(
...
powershell.exe -ExecutionPolicy Bypass -File "%SCRIPT_DIR%scripts\encrypt-credentials.ps1" -AnthropicApiKey "%API_KEY%" -AnthropicBaseUrl "%BASE_URL%" -TavilyApiKey "%TAVILY_KEY%" -OutputPath "%SCRIPT_DIR%conf_opencode"
